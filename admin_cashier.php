    ...
    <div class="tabbed_area">  
       ...
       $result = mysql_query("SELECT * FROM cashier")or die(mysql_error());
        ...
        while($row = mysql_fetch_array( $result )) {
				...
				?>
				<td><a href="update_cashier.php?username=<?php echo $row['username']?>&fname=<?php echo $row['first_name']?>"><img src="images/update-icon.png" width="35" height="35" border="0" /></a></td>
...
?> 
        ...
        <div id="content_2" class="content">  
			  ...
			  echo $message1;
			  ?>
		<form name="form1" onsubmit="return validateForm(this);" action="admin_cashier.php" method="post" >
